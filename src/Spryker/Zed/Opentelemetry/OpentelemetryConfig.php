...
class OpentelemetryConfig extends AbstractBundleConfig
{
    ...
    public function getExcludedSpans(): array
    {
        return [
            ...
            'HomePage-IndexController::indexAction',
            ...
            'MerchantShipment-MerchantShipmentFacade::expandQuoteShipmentWithMerchantReference',
            ...
            'Product-ProductFacade::combineRawProductAttributes',
            'Product-ProductFacade::decodeProductAttributes',
            'Product-ProductFacade::findProductConcreteIdBySku',
            'Product-ProductFacade::findProductConcreteIdsByAbstractProductId',
            'Product-ProductFacade::getCombinedAbstractAttributeKeys',
            'Product-ProductFacade::getLocalizedProductConcreteName',
            'Product-ProductFacade::getRawProductAbstractTransfersByAbstractSkus',
            'Product-ProductFacade::getRawProductConcreteTransfersByConcreteSkus',
            'Product-ProductFacade::hasProductConcrete',
